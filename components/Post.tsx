  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        {post.image && <Image source={{ uri: post.image }} style={styles.contentImage} resizeMode="cover" />}
      </View>

      <View style={styles.actions}>
        <TouchableOpacity style={styles.actionButton} onPress={handleLike}>
          <Heart size={18} color={liked ? "#E0245E" : "#657786"} fill={liked ? "#E0245E" : "transparent"} />
          {likesCount > 0 && <Text style={[styles.actionText, liked && styles.likedText]}>{likesCount}</Text>}
        </TouchableOpacity>
